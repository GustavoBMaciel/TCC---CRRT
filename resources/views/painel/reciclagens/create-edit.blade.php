...
<div class="container">
  ...
  <div class="panel-heading">{{$reciclagemEdit->id or 'Novo'}}</div>
  ...
  @if(isset ($reciclagemEdit))
  {!! Form::model($reciclagemEdit, ['route' => ['reciclagens.update', $reciclagemEdit->id ], 'class' => 'form', 'method' => 'put']) !!}
  @else
  {!! Form::open(['route' => 'reciclagens.store', 'class' => 'form']) !!}
  @endif
